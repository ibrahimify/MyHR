...
class ActiveSanctionsTab(QWidget):
    ...
    def _build(self):
        ...
        ch_icon = QLabel()
        ch_icon.setPixmap(app_pixmap("fa5s.exclamation-triangle", color=tokens().danger, size=18))
...
class IssueSanctionTab(QWidget):
    ...
    def _build(self):
        ...
        title_icon = QLabel()
        title_icon.setPixmap(app_pixmap("fa5s.exclamation-triangle", color=tokens().danger, size=18))
        ...
        date_icon = QLabel()
        date_icon.setPixmap(app_pixmap("fa5s.calendar-alt", color=tokens().text_soft, size=14))
